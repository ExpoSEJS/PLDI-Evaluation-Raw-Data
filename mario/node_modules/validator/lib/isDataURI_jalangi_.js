...
jalangiLabel205:
    while (true) {
        try {
                ...
                jalangiLabel204:
                    while (true) {
                        try {
                            ...
                            return J$.X1(457, J$.Rt(449, J$.M(441, J$.R(425, 'dataURI', dataURI, 1), 'test', 0)(J$.R(433, 'str', str, 0))));
                        } catch (J$e) {
                            J$.Ex(633, J$e);
                        } finally {
                            if (J$.Fr(641))
            ...
            J$.N(577, 'dataURI', dataURI, 0);
            isDataURI = J$.N(593, 'isDataURI', J$.T(585, isDataURI, 12, false, 465), 0);
            ...
            J$.X1(169, J$.P(161, J$.R(145, 'exports', exports, 2), 'default', J$.R(153, 'isDataURI', isDataURI, 1), 0));
            ...
            var dataURI = J$.X1(361, J$.W(353, 'dataURI', J$.T(345, /^\s*data:([a-z]+\/[a-z0-9\-\+]+(;[a-z\-]+=[a-z0-9\-]+)?)?(;base64)?,[a-z0-9!\$&',\(\)\*\+,;=\-\._~:@\/\?%\s]*\s*$/i, 14, false), dataURI, 3));
