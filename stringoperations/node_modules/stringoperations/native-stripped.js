 ...
 */
function allIndexesOf(regex, str, startingFrom = 0) {
 ...
 */
function parsePrimitiveFromString(str) {
...
export { allIndexesOf, capitalize, removeWhitespace, lowerCaseFirst, camelCase, kebabCase, parsePrimitiveFromString };