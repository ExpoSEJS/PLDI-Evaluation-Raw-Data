...
function modelProvider(_Component, options) {
  ...
  var log = (0, _commonUtil.logger)('model-provider');
  ...
  function getModelId(props, options) {
    ...
    if (id === false) {
      ...
      return (0, _commonUtil.deepPropValue)(id, props) || id;
    }
  }
        ...
        (function () {
          ...
          if (id) {
            ...
            if (!modelData && (!_this.state || !_this.state._fetched || !_this.state._fetched[id])) {
              ...
              var modelCache = self.state.modelCache;
              var model = _model3.default.fromCache(modelOptions, modelCache);
  ...
  return _react2.default.createClass({
    ...
    render: function render() {
      ...
      var modelCache = this.state.modelCache;
...
function organizeProps(options) {
  ...
  return Object.assign({}, options, {
    ...
    modelClass: options.modelClass || _model3.default,
