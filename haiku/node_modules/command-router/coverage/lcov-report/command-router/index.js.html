...
<html lang="en">
<head>
    <title>Code coverage report for command-router/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">command-router/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">98.41% <small>(62 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">91.18% <small>(31 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">command-router/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">3</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var extend = require('xtend')
...
CommandRouter.prototype.command = function(route, callback) {
  var cli = this
  var route = route || <span class="branch-1 cbranch-no" title="branch not covered" >'/'</span>
&nbsp;
...
&nbsp;
  Object.keys(cli.defaults).forEach(function(name){
    <span class="missing-if-branch" title="if path not taken" >I</span>if (cli.options[name] === false) <span class="cstat-no" title="statement not covered" >return</span>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof opts.default !== undefined) {
    if (opts.type === path) {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sat Oct 11 2014 01:30:26 GMT-0700 (PDT)</div>
</div>
