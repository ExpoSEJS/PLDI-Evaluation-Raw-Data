...
html
	head
		meta(charset="utf-8")
		title #{self.item.name} (#{self.item.scope || self.item.visibility}) Dokumentation
		link(rel="stylesheet",href="css/jquery.jscrollpane.css",media="all")
		link(rel="stylesheet",href="css/style.css",media="all")
		link(rel="stylesheet",href="css/font-awesome.css",media="all")
		link(rel="stylesheet",href="css/sh.min.css",media="all")
	...
	body#item(onload="sh_highlightDocument();")
		#wrapper
			#main
				aside.items
