/root/Targets/quip.js
└── quip.js@1.0.3 

Setup Done exists, not setting up
:../FeatureTester/libs/:/root/Targets/quip.js/node_modules
...
*-- Stat Module Done --*
*-- Test Case {"_bound":0} start 0.0589 took 2.6482s
*-- Errors occured in test {"_bound":0}
* Error: Tropigate failed because SyntaxError: 'with' in strict mode (26:4) on program (function(){
    var modules = {};
...
}).call(this); at SyntaxError: 'with' in strict mode (26:4)
