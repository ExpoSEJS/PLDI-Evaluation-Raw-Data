...
var Methods = (function (_super) {
    ...
    function Methods(config, endpoint) {
        _super.call(this, config.key, config.secret, config.rsa_key, undefined, { Accept: 'application/json' });
        ...
        return new Promise(function (resolve, reject) {
            ...
            _super.prototype.call.call(_this, options.method, options.path, options.body, function (err, json) {
                if (err)
                    return reject(err);
                if (options.singular)
                    return resolve(json[inflect.pluralize(_this.endpoint)][0]);
                return resolve(json[inflect.pluralize(_this.endpoint)]);
            });
        });
    };
