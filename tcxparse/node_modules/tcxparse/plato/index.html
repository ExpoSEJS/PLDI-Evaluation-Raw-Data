...
<head>
  ...
  <script>
    var __options = {"flags":{"complexity":{"newmi":true},"jshint":{"options":{},"globals":{}}}}
  </script>
  ...
  <div class="row">
    <ul class="file-list list-unstyled">
      ...
      <li class="span12">
        ...
        <span class="span4 file"><a class="file-link" href="./files/index_js/index.html">index.js</a></span>
      ...
      <li class="span12">
        <span class="fade-left fadeout visible-desktop"></span>
        <span class="span4 file"><a class="file-link" href="./files/spec_testSpec_js/index.html">spec/testSpec.js</a></span>
        <span class="span8 file-chart js-file-chart"
              data-lint="8"
              data-sloc="127"
              data-bugs="0.66"
