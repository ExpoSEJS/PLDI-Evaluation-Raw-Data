...
jalangiLabel45:
    while (true) {
        try {
                ...
                jalangiLabel43:
                    while (true) {
                        try {
                            ...
                            res = J$.N(1121, 'res', res, 4);
                            next = J$.N(1129, 'next', next, 4);
                            return J$.X1(1089, J$.Rt(1081, J$.F(1073, J$.R(1041, 'next', next, 0), 0)(J$.F(1065, J$.R(1049, 'Error', Error, 2), 1)(J$.T(1057, 'Doooh...', 21, false)))));
                        } catch (J$e) {
                            J$.Ex(1481, J$e);
                        } finally {
                            if (J$.Fr(1489))
            ...
            }, 12, false, 1097)), 'use', 0)(J$.M(1193, J$.R(1153, 'connect', connect, 1), 'errorHandler', 0)(J$.T(1185, {
                stack: J$.T(1161, true, 23, false),
                message: J$.T(1169, true, 23, false),
                dump: J$.T(1177, false, 23, false)
            }, 11, false))));
            J$.X1(1377, J$.M(1369, J$.R(1217, 'process', process, 2), 'on', 0)(J$.T(1225, 'uncaughtException', 21, false), J$.T(1361, function (err) {
                jalangiLabel44:
                    while (true) {
                        try {
                            J$.Fe(1337, arguments.callee, this, arguments);
                            arguments = J$.N(1345, 'arguments', arguments, 4);
                            err = J$.N(1353, 'err', err, 4);
                            J$.X1(1265, J$.M(1257, J$.R(1233, 'console', console, 2), 'log', 0)(J$.B(42, '+', J$.T(1241, 'Caught exception: ', 21, false), J$.R(1249, 'err', err, 0), 0)));
                            J$.X1(1297, J$.M(1289, J$.R(1273, 'console', console, 2), 'error', 0)(J$.R(1281, 'err', err, 0)));
                            J$.X1(1329, J$.M(1321, J$.R(1305, 'console', console, 2), 'log', 0)(J$.R(1313, 'err', err, 0)));
                        } catch (J$e) {
                            J$.Ex(1497, J$e);
                        } finally {
                            if (J$.Fr(1505))
