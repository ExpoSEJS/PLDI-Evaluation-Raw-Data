...
jalangiLabel1275:
    while (true) {
        try {
            J$.Se(6265, '/home/blake/ExpoSE/Targets/node-flarum/node_modules/mongoose/lib/index_jalangi_.js', '/home/blake/ExpoSE/Targets/node-flarum/node_modules/mongoose/lib/index.js');
            function Mongoose() {
                jalangiLabel1260:
                    while (true) {
                        try {
                            ...
                            if (J$.Fr(6473))
                                continue jalangiLabel1260;
                            else
                                return J$.Ra();
                        }
                    }
            }
            J$.N(6273, '__secret__S$', __secret__S$, 0);
            J$.N(6281, '__secret__traits__', __secret__traits__, 0);
            J$.N(6289, 'Schema', Schema, 0);
            J$.N(6297, 'SchemaType', SchemaType, 0);
            J$.N(6305, 'VirtualType', VirtualType, 0);
            J$.N(6313, 'STATES', STATES, 0);
            J$.N(6321, 'Types', Types, 0);
            J$.N(6329, 'Query', Query, 0);
            J$.N(6337, 'Model', Model, 0);
            J$.N(6345, 'Document', Document, 0);
            J$.N(6353, 'utils', utils, 0);
            J$.N(6361, 'format', format, 0);
            J$.N(6369, 'pkg', pkg, 0);
            J$.N(6377, 'querystring', querystring, 0);
            J$.N(6385, 'Aggregate', Aggregate, 0);
            J$.N(6393, 'PromiseProvider', PromiseProvider, 0);
            Mongoose = J$.N(6409, 'Mongoose', J$.T(6401, Mongoose, 12, false, 889), 0);
            J$.N(6417, 'rgxReplSet', rgxReplSet, 0);
            J$.N(6425, 'checkReplicaSetInUri', checkReplicaSetInUri, 0);
            J$.N(6433, 'driver', driver, 0);
            J$.N(6441, 'Connection', Connection, 0);
            J$.N(6449, 'Collection', Collection, 0);
            J$.N(6457, 'mongoose', mongoose, 0);
                ...
                jalangiLabel1261:
                    while (true) {
                        try {
                            ...
                            if (J$.X1(6481, J$.C(8, J$.B(10, '==', J$.G(977, J$.R(969, 'arguments', arguments, 2), 'length', 0), J$.T(985, 1, 22, false), 0)))) {
                ...
                jalangiLabel1262:
                    while (true) {
                        try {
                            ...
                            J$.N(1569, 'obj', obj, 0);
                            if (J$.X1(6505, J$.C(16, J$.U(18, '!', J$.R(1249, 'uri', uri, 0))))) {
                            ...
                            if (J$.X1(6521, J$.C(40, J$.B(34, '!==', J$.R(1345, 'queryStringStart', queryStringStart, 0), J$.U(26, '-', J$.T(1353, 1, 22, false)), 0)))) {
                                try {
                                    ...
                                    if (J$.X1(6513, J$.C(32, J$.C(24, J$.R(1425, 'obj', obj, 0)) ? J$.G(1441, J$.R(1433, 'obj', obj, 0), 'replicaSet', 0) : J$._()))) {
                ...
                jalangiLabel1263:
                    while (true) {
                        try {
                            ...
                            if (J$.X1(6561, J$.C(96, J$.G(1705, J$.R(1697, 'arguments', arguments, 2), 'length', 0)))) {
                                if (J$.X1(6553, J$.C(88, J$.C(48, J$.M(1745, J$.R(1713, 'rgxReplSet', rgxReplSet, 1), 'test', 0)(J$.G(1737, J$.R(1721, 'arguments', arguments, 2), J$.T(1729, 0, 22, false), 4))) ? J$._() : J$.F(1785, J$.R(1753, 'checkReplicaSetInUri', checkReplicaSetInUri, 1), 0)(J$.G(1777, J$.R(1761, 'arguments', arguments, 2), J$.T(1769, 0, 22, false), 4))))) {
                                    J$.X1(1833, J$.M(1825, J$.G(1801, J$.R(1793, 'conn', conn, 0), 'openSet', 0), 'apply', 0)(J$.R(1809, 'conn', conn, 0), J$.R(1817, 'arguments', arguments, 2)));
                                } else if (J$.X1(6545, J$.C(80, J$.C(72, J$.C(56, J$.R(1841, 'options', options, 0)) ? J$.G(1857, J$.R(1849, 'options', options, 0), 'replset', 0) : J$._()) ? J$.C(64, J$.G(1881, J$.G(1873, J$.R(1865, 'options', options, 0), 'replset', 0), 'replicaSet', 0)) ? J$._() : J$.G(1905, J$.G(1897, J$.R(1889, 'options', options, 0), 'replset', 0), 'rs_name', 0) : J$._()))) {
                ...
                jalangiLabel1264:
                    while (true) {
                        try {
                            ...
                            if (J$.X1(6585, J$.C(112, J$.C(104, J$.M(2177, J$.R(2145, 'rgxReplSet', rgxReplSet, 1), 'test', 0)(J$.G(2169, J$.R(2153, 'arguments', arguments, 2), J$.T(2161, 0, 22, false), 4))) ? J$._() : J$.F(2217, J$.R(2185, 'checkReplicaSetInUri', checkReplicaSetInUri, 1), 0)(J$.G(2209, J$.R(2193, 'arguments', arguments, 2), J$.T(2201, 0, 22, false), 4))))) {
                ...
                jalangiLabel1267:
                    while (true) {
                        try {
                            ...
                            if (J$.Fr(6681))
                                continue jalangiLabel1267;
                            else
                                return J$.Ra();
                        }
                    }
            }, 12, false, 2777), 0));
            J$.X1(4377, J$.P(4369, J$.G(2849, J$.R(2841, 'Mongoose', Mongoose, 1), 'prototype', 0), 'model', J$.T(4361, function (name, schema, collection, skipInit) {
                jalangiLabel1268:
                    while (true) {
                        try {
                            J$.Fe(4281, arguments.callee, this, arguments);
                            arguments = J$.N(4289, 'arguments', arguments, 4);
                            name = J$.N(4297, 'name', name, 4);
                            schema = J$.N(4305, 'schema', schema, 4);
                            collection = J$.N(4313, 'collection', collection, 4);
                            skipInit = J$.N(4321, 'skipInit', skipInit, 4);
                            J$.N(4329, 'options', options, 0);
                            J$.N(4337, 'model', model, 0);
                            J$.N(4345, 'sub', sub, 0);
                            J$.N(4353, 'connection', connection, 0);
                            if (J$.X1(6689, J$.C(160, J$.B(74, '==', J$.T(2857, 'string', 21, false), J$.U(66, 'typeof', J$.R(2865, 'schema', schema, 0)), 0)))) {
                            ...
                            if (J$.X1(6697, J$.C(176, J$.C(168, J$.M(2937, J$.R(2921, 'utils', utils, 1), 'isObject', 0)(J$.R(2929, 'schema', schema, 0))) ? J$.U(82, '!', J$.G(2953, J$.R(2945, 'schema', schema, 0), 'instanceOfSchema', 0)) : J$._()))) {
                                J$.X1(2993, schema = J$.W(2985, 'schema', J$.F(2977, J$.R(2961, 'Schema', Schema, 1), 1)(J$.R(2969, 'schema', schema, 0)), schema, 0));
                            }
                            if (J$.X1(6705, J$.C(184, J$.B(98, '===', J$.T(3001, 'boolean', 21, false), J$.U(90, 'typeof', J$.R(3009, 'collection', collection, 0)), 0)))) {
                            ...
                            var options;
                            if (J$.X1(6713, J$.C(200, J$.C(192, J$.R(3065, 'skipInit', skipInit, 0)) ? J$.M(3089, J$.R(3073, 'utils', utils, 1), 'isObject', 0)(J$.R(3081, 'skipInit', skipInit, 0)) : J$._()))) {
                            ...
                            if (J$.X1(6729, J$.C(216, J$.U(106, '!', J$.G(3193, J$.G(3177, J$.R(3169, 'this', this, 0), 'modelSchemas', 0), J$.R(3185, 'name', name, 0), 4))))) {
                                if (J$.X1(6721, J$.C(208, J$.R(3201, 'schema', schema, 0)))) {
                            ...
                            var model;
                            var sub;
                            if (J$.X1(6753, J$.C(264, J$.C(224, J$.G(3361, J$.G(3345, J$.R(3337, 'this', this, 0), 'models', 0), J$.R(3353, 'name', name, 0), 4)) ? J$.B(114, '!==', J$.T(3369, false, 23, false), J$.G(3385, J$.R(3377, 'options', options, 0), 'cache', 0), 0) : J$._()))) {
                                if (J$.X1(6737, J$.C(248, J$.C(240, J$.C(232, J$.R(3393, 'schema', schema, 0)) ? J$.G(3409, J$.R(3401, 'schema', schema, 0), 'instanceOfSchema', 0) : J$._()) ? J$.B(122, '!=', J$.R(3417, 'schema', schema, 0), J$.G(3457, J$.G(3449, J$.G(3433, J$.R(3425, 'this', this, 0), 'models', 0), J$.R(3441, 'name', name, 0), 4), 'schema', 0), 0) : J$._()))) {
                                    throw J$.X1(3505, J$.Th(3497, J$.M(3489, J$.G(3473, J$.R(3465, 'mongoose', mongoose, 1), 'Error', 0), 'OverwriteModelError', 2)(J$.R(3481, 'name', name, 0))));
                                }
                                if (J$.X1(6745, J$.C(256, J$.R(3513, 'collection', collection, 0)))) {
                                    J$.X1(3561, model = J$.W(3553, 'model', J$.G(3545, J$.G(3529, J$.R(3521, 'this', this, 0), 'models', 0), J$.R(3537, 'name', name, 0), 4), model, 0));
                                    J$.X1(3601, schema = J$.W(3593, 'schema', J$.G(3585, J$.G(3577, J$.R(3569, 'model', model, 0), 'prototype', 0), 'schema', 0), schema, 0));
                                    J$.X1(3665, sub = J$.W(3657, 'sub', J$.M(3649, J$.R(3609, 'model', model, 0), '__subclass', 0)(J$.G(3625, J$.R(3617, 'this', this, 0), 'connection', 0), J$.R(3633, 'schema', schema, 0), J$.R(3641, 'collection', collection, 0)), sub, 0));
                                    return J$.X1(3689, J$.Rt(3681, J$.R(3673, 'sub', sub, 0)));
                                }
                                return J$.X1(3737, J$.Rt(3729, J$.G(3721, J$.G(3705, J$.R(3697, 'this', this, 0), 'models', 0), J$.R(3713, 'name', name, 0), 4)));
                            }
                            if (J$.X1(6769, J$.C(280, J$.U(130, '!', J$.R(3745, 'schema', schema, 0))))) {
                                J$.X1(3793, schema = J$.W(3785, 'schema', J$.G(3777, J$.G(3761, J$.R(3753, 'this', this, 0), 'modelSchemas', 0), J$.R(3769, 'name', name, 0), 4), schema, 0));
                                if (J$.X1(6761, J$.C(272, J$.U(138, '!', J$.R(3801, 'schema', schema, 0))))) {
                                    throw J$.X1(3849, J$.Th(3841, J$.M(3833, J$.G(3817, J$.R(3809, 'mongoose', mongoose, 1), 'Error', 0), 'MissingSchemaError', 2)(J$.R(3825, 'name', name, 0))));
                                }
                            }
                            if (J$.X1(6777, J$.C(288, J$.U(154, '!', J$.B(146, 'in', J$.T(3857, 'pluralization', 21, false), J$.G(3873, J$.R(3865, 'schema', schema, 0), 'options', 0), 0)))))
                                J$.X1(3929, J$.P(3921, J$.G(3889, J$.R(3881, 'schema', schema, 0), 'options', 0), 'pluralization', J$.G(3913, J$.G(3905, J$.R(3897, 'this', this, 0), 'options', 0), 'pluralization', 0), 0));
                            if (J$.X1(6785, J$.C(304, J$.U(162, '!', J$.R(3937, 'collection', collection, 0))))) {
                                J$.X1(4017, collection = J$.W(4009, 'collection', J$.C(296, J$.M(3961, J$.R(3945, 'schema', schema, 0), 'get', 0)(J$.T(3953, 'collection', 21, false))) ? J$._() : J$.F(4001, J$.R(3969, 'format', format, 1), 0)(J$.R(3977, 'name', name, 0), J$.G(3993, J$.R(3985, 'schema', schema, 0), 'options', 0)), collection, 0));
                            }
                            var connection = J$.X1(4065, J$.W(4057, 'connection', J$.C(312, J$.G(4033, J$.R(4025, 'options', options, 0), 'connection', 0)) ? J$._() : J$.G(4049, J$.R(4041, 'this', this, 0), 'connection', 0), connection, 1));
                            J$.X1(4137, model = J$.W(4129, 'model', J$.M(4121, J$.R(4073, 'Model', Model, 1), 'compile', 0)(J$.R(4081, 'name', name, 0), J$.R(4089, 'schema', schema, 0), J$.R(4097, 'collection', collection, 0), J$.R(4105, 'connection', connection, 0), J$.R(4113, 'this', this, 0)), model, 0));
                            if (J$.X1(6793, J$.C(320, J$.U(170, '!', J$.R(4145, 'skipInit', skipInit, 0))))) {
                                J$.X1(4169, J$.M(4161, J$.R(4153, 'model', model, 0), 'init', 0)());
                            }
                            if (J$.X1(6801, J$.C(328, J$.B(178, '===', J$.T(4177, false, 23, false), J$.G(4193, J$.R(4185, 'options', options, 0), 'cache', 0), 0)))) {
                                return J$.X1(4217, J$.Rt(4209, J$.R(4201, 'model', model, 0)));
                            }
                            return J$.X1(4273, J$.Rt(4265, J$.P(4257, J$.G(4233, J$.R(4225, 'this', this, 0), 'models', 0), J$.R(4241, 'name', name, 0), J$.R(4249, 'model', model, 0), 2)));
                        } catch (J$e) {
                            J$.Ex(6809, J$e);
                        } finally {
                            if (J$.Fr(6817))
                                continue jalangiLabel1268;
                            else
                                return J$.Ra();
                        }
                    }
            }, 12, false, 4281), 0));
            J$.X1(4513, J$.P(4505, J$.G(4393, J$.R(4385, 'Mongoose', Mongoose, 1), 'prototype', 0), 'modelNames', J$.T(4497, function () {
                jalangiLabel1269:
                    while (true) {
                        try {
                            J$.Fe(4473, arguments.callee, this, arguments);
                            arguments = J$.N(4481, 'arguments', arguments, 4);
                            J$.N(4489, 'names', names, 0);
                            var names = J$.X1(4441, J$.W(4433, 'names', J$.M(4425, J$.R(4401, 'Object', Object, 2), 'keys', 0)(J$.G(4417, J$.R(4409, 'this', this, 0), 'models', 0)), names, 1));
                            return J$.X1(4465, J$.Rt(4457, J$.R(4449, 'names', names, 0)));
                        } catch (J$e) {
                            J$.Ex(6825, J$e);
                        } finally {
                            if (J$.Fr(6833))
                                continue jalangiLabel1269;
                            else
                                return J$.Ra();
                        }
                    }
            }, 12, false, 4473), 0));
            J$.X1(4825, J$.P(4817, J$.G(4529, J$.R(4521, 'Mongoose', Mongoose, 1), 'prototype', 0), '_applyPlugins', J$.T(4809, function (schema) {
                jalangiLabel1270:
                    while (true) {
                        try {
                            J$.Fe(4769, arguments.callee, this, arguments);
                            arguments = J$.N(4777, 'arguments', arguments, 4);
                            schema = J$.N(4785, 'schema', schema, 4);
                            J$.N(4793, 'i', i, 0);
                            J$.N(4801, 'l', l, 0);
                            for (var i = J$.X1(4577, J$.W(4569, 'i', J$.T(4537, 0, 22, false), i, 1)), l = J$.X1(4593, J$.W(4585, 'l', J$.G(4561, J$.G(4553, J$.R(4545, 'this', this, 0), 'plugins', 0), 'length', 0), l, 1)); J$.X1(6841, J$.C(336, J$.B(186, '<', J$.R(4601, 'i', i, 0), J$.R(4609, 'l', l, 0), 0))); J$.X1(6849, J$.B(210, '-', i = J$.W(4633, 'i', J$.B(202, '+', J$.U(194, '+', J$.R(4625, 'i', i, 0)), J$.T(4617, 1, 22, false), 0), i, 0), J$.T(4641, 1, 22, false), 0))) {
                                J$.X1(4761, J$.M(4753, J$.R(4649, 'schema', schema, 0), 'plugin', 0)(J$.G(4697, J$.G(4681, J$.G(4665, J$.R(4657, 'this', this, 0), 'plugins', 0), J$.R(4673, 'i', i, 0), 4), J$.T(4689, 0, 22, false), 4), J$.G(4745, J$.G(4729, J$.G(4713, J$.R(4705, 'this', this, 0), 'plugins', 0), J$.R(4721, 'i', i, 0), 4), J$.T(4737, 1, 22, false), 4)));
                            }
                        } catch (J$e) {
                            J$.Ex(6857, J$e);
                        } finally {
                            if (J$.Fr(6865))
                                continue jalangiLabel1270;
                            else
                                return J$.Ra();
                        }
                    }
            }, 12, false, 4769), 0));
            J$.X1(4977, J$.P(4969, J$.G(4841, J$.R(4833, 'Mongoose', Mongoose, 1), 'prototype', 0), 'plugin', J$.T(4961, function (fn, opts) {
                jalangiLabel1271:
                    while (true) {
                        try {
                            ...
                            fn = J$.N(4945, 'fn', fn, 4);
                            opts = J$.N(4953, 'opts', opts, 4);
                            J$.X1(4897, J$.M(4889, J$.G(4857, J$.R(4849, 'this', this, 0), 'plugins', 0), 'push', 0)(J$.T(4881, [
                                J$.R(4865, 'fn', fn, 0),
                                J$.R(4873, 'opts', opts, 0)
                            ], 10, false)));
                            ...
                            if (J$.Fr(6881))
                                continue jalangiLabel1271;
                            else
                                return J$.Ra();
                        }
                    }
            }, 12, false, 4929), 0));
            J$.X1(5089, J$.M(5081, J$.G(4993, J$.R(4985, 'Mongoose', Mongoose, 1), 'prototype', 0), '__defineGetter__', 0)(J$.T(5001, 'connection', 21, false), J$.T(5073, function () {
                jalangiLabel1272:
                    while (true) {
                        try {
                            J$.Fe(5057, arguments.callee, this, arguments);
                            arguments = J$.N(5065, 'arguments', arguments, 4);
                            return J$.X1(5049, J$.Rt(5041, J$.G(5033, J$.G(5017, J$.R(5009, 'this', this, 0), 'connections', 0), J$.T(5025, 0, 22, false), 4)));
                        } catch (J$e) {
                            J$.Ex(6889, J$e);
                        } finally {
                            if (J$.Fr(6897))
                                continue jalangiLabel1272;
                            else
                                return J$.Ra();
                        }
                    }
            }, 12, false, 5057)));
            var driver = J$.X1(5129, J$.W(5121, 'driver', J$.C(344, J$.G(5105, J$.R(5097, 'global', global, 2), 'MONGOOSE_DRIVER_PATH', 0)) ? J$._() : J$.T(5113, './drivers/node-mongodb-native', 21, false), driver, 3));
            var Connection = J$.X1(5177, J$.W(5169, 'Connection', J$.F(5161, J$.R(5137, 'require', require, 2), 0)(J$.B(218, '+', J$.R(5145, 'driver', driver, 1), J$.T(5153, '/connection', 21, false), 0)), Connection, 3));
            var Collection = J$.X1(5225, J$.W(5217, 'Collection', J$.F(5209, J$.R(5185, 'require', require, 2), 0)(J$.B(226, '+', J$.R(5193, 'driver', driver, 1), J$.T(5201, '/collection', 21, false), 0)), Collection, 3));
            J$.X1(5265, J$.P(5257, J$.G(5241, J$.R(5233, 'Mongoose', Mongoose, 1), 'prototype', 0), 'Aggregate', J$.R(5249, 'Aggregate', Aggregate, 1), 0));
            J$.X1(5305, J$.P(5297, J$.G(5281, J$.R(5273, 'Mongoose', Mongoose, 1), 'prototype', 0), 'Collection', J$.R(5289, 'Collection', Collection, 1), 0));
            J$.X1(5345, J$.P(5337, J$.G(5321, J$.R(5313, 'Mongoose', Mongoose, 1), 'prototype', 0), 'Connection', J$.R(5329, 'Connection', Connection, 1), 0));
            J$.X1(5393, J$.P(5385, J$.G(5361, J$.R(5353, 'Mongoose', Mongoose, 1), 'prototype', 0), 'version', J$.G(5377, J$.R(5369, 'pkg', pkg, 1), 'version', 0), 0));
            J$.X1(5433, J$.P(5425, J$.G(5409, J$.R(5401, 'Mongoose', Mongoose, 1), 'prototype', 0), 'Mongoose', J$.R(5417, 'Mongoose', Mongoose, 1), 0));
            J$.X1(5473, J$.P(5465, J$.G(5449, J$.R(5441, 'Mongoose', Mongoose, 1), 'prototype', 0), 'Schema', J$.R(5457, 'Schema', Schema, 1), 0));
            J$.X1(5513, J$.P(5505, J$.G(5489, J$.R(5481, 'Mongoose', Mongoose, 1), 'prototype', 0), 'SchemaType', J$.R(5497, 'SchemaType', SchemaType, 1), 0));
            J$.X1(5561, J$.P(5553, J$.G(5529, J$.R(5521, 'Mongoose', Mongoose, 1), 'prototype', 0), 'SchemaTypes', J$.G(5545, J$.R(5537, 'Schema', Schema, 1), 'Types', 0), 0));
            J$.X1(5601, J$.P(5593, J$.G(5577, J$.R(5569, 'Mongoose', Mongoose, 1), 'prototype', 0), 'VirtualType', J$.R(5585, 'VirtualType', VirtualType, 1), 0));
            J$.X1(5641, J$.P(5633, J$.G(5617, J$.R(5609, 'Mongoose', Mongoose, 1), 'prototype', 0), 'Types', J$.R(5625, 'Types', Types, 1), 0));
            J$.X1(5681, J$.P(5673, J$.G(5657, J$.R(5649, 'Mongoose', Mongoose, 1), 'prototype', 0), 'Query', J$.R(5665, 'Query', Query, 1), 0));
            J$.X1(5857, J$.M(5849, J$.R(5689, 'Object', Object, 2), 'defineProperty', 0)(J$.G(5705, J$.R(5697, 'Mongoose', Mongoose, 1), 'prototype', 0), J$.T(5713, 'Promise', 21, false), J$.T(5841, {
                get: J$.T(5769, function () {
                    jalangiLabel1273:
                        while (true) {
                            try {
                                J$.Fe(5753, arguments.callee, this, arguments);
                                arguments = J$.N(5761, 'arguments', arguments, 4);
                                return J$.X1(5745, J$.Rt(5737, J$.M(5729, J$.R(5721, 'PromiseProvider', PromiseProvider, 1), 'get', 0)()));
                            } catch (J$e) {
                                J$.Ex(6905, J$e);
                            } finally {
                                if (J$.Fr(6913))
                                    continue jalangiLabel1273;
                                else
                                    return J$.Ra();
                            }
                        }
                }, 12, false, 5753),
                set: J$.T(5833, function (lib) {
                    jalangiLabel1274:
                        while (true) {
                            try {
                                J$.Fe(5809, arguments.callee, this, arguments);
                                arguments = J$.N(5817, 'arguments', arguments, 4);
                                lib = J$.N(5825, 'lib', lib, 4);
                                J$.X1(5801, J$.M(5793, J$.R(5777, 'PromiseProvider', PromiseProvider, 1), 'set', 0)(J$.R(5785, 'lib', lib, 0)));
                            } catch (J$e) {
                                J$.Ex(6921, J$e);
                            } finally {
                                if (J$.Fr(6929))
                                    continue jalangiLabel1274;
                                else
                                    return J$.Ra();
                            }
                        }
            ...
            J$.X1(5897, J$.P(5889, J$.G(5873, J$.R(5865, 'Mongoose', Mongoose, 1), 'prototype', 0), 'PromiseProvider', J$.R(5881, 'PromiseProvider', PromiseProvider, 1), 0));
            J$.X1(5937, J$.P(5929, J$.G(5913, J$.R(5905, 'Mongoose', Mongoose, 1), 'prototype', 0), 'Model', J$.R(5921, 'Model', Model, 1), 0));
            J$.X1(5977, J$.P(5969, J$.G(5953, J$.R(5945, 'Mongoose', Mongoose, 1), 'prototype', 0), 'Document', J$.R(5961, 'Document', Document, 1), 0));
            J$.X1(6033, J$.P(6025, J$.G(5993, J$.R(5985, 'Mongoose', Mongoose, 1), 'prototype', 0), 'DocumentProvider', J$.F(6017, J$.R(6001, 'require', require, 2), 0)(J$.T(6009, './document_provider', 21, false)), 0));
            J$.X1(6089, J$.P(6081, J$.G(6049, J$.R(6041, 'Mongoose', Mongoose, 1), 'prototype', 0), 'Error', J$.F(6073, J$.R(6057, 'require', require, 2), 0)(J$.T(6065, './error', 21, false)), 0));
            J$.X1(6145, J$.P(6137, J$.G(6105, J$.R(6097, 'Mongoose', Mongoose, 1), 'prototype', 0), 'mongo', J$.F(6129, J$.R(6113, 'require', require, 2), 0)(J$.T(6121, 'mongodb', 21, false)), 0));
            J$.X1(6201, J$.P(6193, J$.G(6161, J$.R(6153, 'Mongoose', Mongoose, 1), 'prototype', 0), 'mquery', J$.F(6185, J$.R(6169, 'require', require, 2), 0)(J$.T(6177, 'mquery', 21, false)), 0));
            var mongoose = J$.X1(6257, J$.W(6249, 'mongoose', J$.P(6241, J$.R(6209, 'module', module, 2), 'exports', exports = J$.W(6233, 'exports', J$.F(6225, J$.R(6217, 'Mongoose', Mongoose, 1), 1)(), J$.I(typeof exports === 'undefined' ? undefined : exports), 4), 0), mongoose, 3));
        } catch (J$e) {
            J$.Ex(6937, J$e);
        } finally {
            if (J$.Sr(6945)) {
                J$.L();
                continue jalangiLabel1275;
            } else {
                J$.L();
                break jalangiLabel1275;
            }
        }
    }
