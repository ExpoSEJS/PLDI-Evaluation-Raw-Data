...
jalangiLabel3716:
    while (true) {
        try {
            J$.Se(1049, '/home/blake/ExpoSE/Targets/node-flarum/node_modules/mongoose/lib/schema/mixed_jalangi_.js', '/home/blake/ExpoSE/Targets/node-flarum/node_modules/mongoose/lib/schema/mixed.js');
            function Mixed(path, options) {
                jalangiLabel3712:
                    while (true) {
                        try {
            ...
            if (J$.Sr(1225)) {
                J$.L();
                continue jalangiLabel3716;
            } else {
                J$.L();
                break jalangiLabel3716;
            }
        }
    }
